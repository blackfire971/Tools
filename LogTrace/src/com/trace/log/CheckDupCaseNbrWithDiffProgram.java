...
public class CheckDupCaseNbrWithDiffProgram {
    ...
    public static String getValueFormDB(Connection conn, String value) {
        ...
        sqlString = "select * from edcms.cases cs1, edcms.cases cs2 where cs1.case_nbr=cs2.case_nbr and cs1.program_id<>cs2.program_id and cs1.account_id=cs2.account_id " +
                " and cs1.case_nbr ='"+rPad(value, 16, ' ')+"'";
    ...
    public static void process(String incomingFile, String outgoingFile) {
        ...
        try { // 防止文件建立或读取失败，用catch捕捉错误并打印，也可以throw  
            ...
            do {
                ...
                //split
                tmpArr = line.split(",");
                tmpString = getValueFormDB(conn, tmpArr[0].trim());
    ...
    public static void main(String[] args) {
        process("D:\\working\\0814\\tmp_csv.csv", "D:\\working\\0814\\result_dup.csv");
    }
