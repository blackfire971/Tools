...
public class Compare2MonthlyUpdateFile {
    ...
    public static String getValueFormDB(Connection conn, String value) {
        ...
        sqlString = " " + 
                "select card.pan " + 
                "  from edcfl.cases, edcfl.program_access, edcfl.cardholder, edcfl.card " + 
        ...
        try { // 防止文件建立或读取失败，用catch捕捉错误并打印，也可以throw  
            ...
            do {
              ...
              //split
                ...
                if (tmpPan != null) {
                    out.write( "-1" + "," + "03/09/2016" + "," + "Clearing report 03/08/2016 Merchant posted debit" +","+ tmpPan.trim() + ",-" + tmpArr[1].trim() + ","+ "DEBIT"); // 即为换行
                    out.write("\r\n");
                } else {
                    continue;
                }
    ...
    public static void main(String[] args) {
        process("C:\\working\\0309\\incoming.txt", "C:\\working\\0309\\result.txt");
    }
