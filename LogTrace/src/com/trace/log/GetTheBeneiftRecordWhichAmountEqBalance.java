...
public class GetTheBeneiftRecordWhichAmountEqBalance {
    
    public static String getValueFormDB(Connection conn, String value, String value2) {
        String sqlString = "";
        PreparedStatement ps = null;
        ResultSet rs = null;
        String resultString = null;
        
        sqlString = "select cases.case_nbr from "
        		+ "edcohtanf.cases, edcohtanf.benefit where "
        		+ "cases.case_id = benefit.case_id "
        		+ "and benefit.AUTHORIZATION_NBR='"+ value +"' "
        		+ "and cases.case_nbr='"+rPad(value2, 16, ' ')+"' " 
        		+ "and benefit.amount=benefit.balance";
        ...
        try { // 防止文件建立或读取失败，用catch捕捉错误并打印，也可以throw  
            ...
            do {
              ...
              //split
                ...
                caseNbr = getValueFormDB(conn, tmpArr[7], tmpArr[0]);
    ...
    public static void main(String[] args) {
        process("D:\\working\\1014\\Unpinned_Result_092115.csv", "D:\\working\\1014\\result.csv");
    }
