...
public class GetBalanceByCaseNbr {
    ...
    public static String getValueFormDB(Connection conn, String value) {
        ...
        sqlString = "select sum(b1.balance) balance " + 
                "  from edcohtanf.benefit b1 " + 
                " where b1.case_id in " + 
                "       (select cs1.case_id " + 
                "          from edcohtanf.cases cs1 " + 
                "         where cs1.account_id in " + 
                "               (select cs2.account_id " + 
                "                  from edcohtanf.cases cs2 " + 
                " where cs2.case_nbr = '"+rPad(value, 16, ' ')+"' ))";
        ...
        try { // 防止文件建立或读取失败，用catch捕捉错误并打印，也可以throw  
            ...
            do {
              ...
              //split
                ...
                tmpResultString = getValueFormDB(conn, tmpArr[0]);
                if (tmpResultString != null) {
                    out.write(tmpArr[0] + "," + tmpResultString); // 即为换行
                    out.write("\r\n");
                }else {
    ...
    public static void main(String[] args) {
        process("D:\\working\\1103\\89007_balance.txt", "D:\\working\\1103\\89007_balance_result.txt");
    }
