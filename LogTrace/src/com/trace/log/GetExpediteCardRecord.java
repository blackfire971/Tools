...
public class GetExpediteCardRecord {
        ...
        try { // 防止文件建立或读取失败，用catch捕捉错误并打印，也可以throw  
            ...
            do {
                ...
                if (line != null && line.trim().length() >0) {
                    if (line.substring(81, 82).equals("1")) {
                        out.write(line); // 即为换行
                        out.write("\r\n");
                    }else {
                        out2.write(line); // 即为换行
                        out2.write("\r\n");
                    }
                }
    ...
    public static void main(String[] args) {
        process("D:\\working\\0918\\GA_new\\remove_dup_GA_output_0901_16.txt", "D:\\working\\0918\\GA_new\\ga_exp.txt", "D:\\working\\0918\\GA_new\\ga_normal.txt");
    }
